...
## Project Log
- 2026-02-04: Added multimodal support (images) to AI chat panel with MessageContentPart enum, image upload UI, vision model detection, and 5MB size validation. Added comprehensive tests for imageUtils.
